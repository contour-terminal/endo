...
// On Windows, winsock2.h MUST precede windows.h (which platform/SystemPipe.hpp
// pulls in via platform/Types.hpp), so this block comes before any other include.
// clang-format off
#if defined(_WIN32)
    #include <winsock2.h>
    #include <windows.h>
