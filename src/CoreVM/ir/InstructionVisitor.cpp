...
// float
IS_SAME_INSTR_IMPL(FNegInstr)
IS_SAME_INSTR_IMPL(FAddInstr)
IS_SAME_INSTR_IMPL(FSubInstr)
IS_SAME_INSTR_IMPL(FMulInstr)
IS_SAME_INSTR_IMPL(FDivInstr)
IS_SAME_INSTR_IMPL(FRemInstr)
IS_SAME_INSTR_IMPL(FPowInstr)
IS_SAME_INSTR_IMPL(FCmpEQInstr)
IS_SAME_INSTR_IMPL(FCmpNEInstr)
IS_SAME_INSTR_IMPL(FCmpLEInstr)
IS_SAME_INSTR_IMPL(FCmpGEInstr)
IS_SAME_INSTR_IMPL(FCmpLTInstr)
IS_SAME_INSTR_IMPL(FCmpGTInstr)
