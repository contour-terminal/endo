...
/// Describes the origin of a function application expression.
enum class ApplicationOrigin : uint8_t
{
    Explicit, ///< Explicitly written in source: `f arg`
    Implicit, ///< Generated by implicit unit function call at statement level: bare `f` → `f ()`
};
