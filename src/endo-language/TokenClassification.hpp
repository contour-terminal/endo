...
[[nodiscard]] constexpr bool isShellBuiltin(std::string_view name) noexcept
{
    return name == "cd" || name == "echo" || name == "exit" || name == "export" || name == "pwd"
           || name == "rm" || name == "env" || name == "read" || name == "time" || name == "fg"
           || name == "bg" || name == "source" || name == "alias" || name == "unalias" || name == "set"
           || name == "unset" || name == "jobs" || name == "kill" || name == "wait" || name == "eval"
           || name == "test" || name == "true" || name == "false" || name == "set_prompt_preset"
