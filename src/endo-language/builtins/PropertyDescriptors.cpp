...
static constexpr std::array promptProperties = {
    PropertyDescriptor {
        .name="shell_prompt_preset", .type=CoreVM::LiteralType::String,
        ...
        .readOnly=false, .enumValues=presetValues,
    },
    PropertyDescriptor {
        .name="shell_prompt_indicator", .type=CoreVM::LiteralType::String,
        .description="Prompt indicator character(s)",
        .detail="**shell_prompt_indicator** -- property\n\nSets the prompt indicator character(s).",
    },
    PropertyDescriptor {
        .name="shell_prompt_layout", .type=CoreVM::LiteralType::String,
        ...
        .readOnly=false, .enumValues=layoutValues,
    },
    PropertyDescriptor {
        .name="shell_prompt_separator", .type=CoreVM::LiteralType::String,
        .description="Prompt separator style",
        .detail="**shell_prompt_separator** -- property\n\nSets the separator style between prompt modules.",
        .readOnly=false, .enumValues=separatorValues,
    },
    PropertyDescriptor {
        .name="shell_prompt_transient", .type=CoreVM::LiteralType::String,
        ...
        .readOnly=false, .enumValues=transientValues,
    },
    PropertyDescriptor {
        .name="shell_prompt_duration_threshold", .type=CoreVM::LiteralType::Number,
    ...
    PropertyDescriptor {
        .name="shell_prompt_spacing", .type=CoreVM::LiteralType::Number,
        .description="Blank lines above/below prompt (0 or 1)",
        .detail="**shell_prompt_spacing** -- property\n\nNumber of blank lines above/below the prompt (0 or 1).",
    },
    PropertyDescriptor {
        .name="shell_exit_confirm_timeout", .type=CoreVM::LiteralType::Number,
    ...
    PropertyDescriptor {
        .name="shell_ls_icons", .type=CoreVM::LiteralType::Boolean,
    ...
    PropertyDescriptor {
        .name="shell_ls_directory_slash", .type=CoreVM::LiteralType::Boolean,
    ...
    PropertyDescriptor {
        .name="shell_is_interactive", .type=CoreVM::LiteralType::Boolean,
...
static constexpr std::array agentProperties = {
    ...
    PropertyDescriptor {
        .name="agent_provider", .type=CoreVM::LiteralType::String,
        ...
        .readOnly=false, .enumValues=providerValues,
    },
    PropertyDescriptor {
        .name="agent_prompt_indicator", .type=CoreVM::LiteralType::String,
    ...
    PropertyDescriptor {
        .name="agent_max_tool_result_size", .type=CoreVM::LiteralType::Number,
    ...
    PropertyDescriptor {
        .name="agent_log_tool_uses", .type=CoreVM::LiteralType::Boolean,
    ...
    // --- Claude provider ---
    PropertyDescriptor {
        .name="agent_claude_api_key", .type=CoreVM::LiteralType::String,
        .description="Claude API key",
        .detail="**agent_claude_api_key** -- property\n\nSets the Claude API key.",
    },
    PropertyDescriptor {
        .name="agent_claude_api_key_env", .type=CoreVM::LiteralType::String,
    ...
    PropertyDescriptor {
        .name="agent_claude_model", .type=CoreVM::LiteralType::String,
        .description="Claude model identifier",
        .detail="**agent_claude_model** -- property\n\nSets the Claude model identifier.",
        .readOnly=false, .enumValues=claudeModelValues,
    },
    PropertyDescriptor {
        .name="agent_claude_max_tokens", .type=CoreVM::LiteralType::Number,
        .description="Claude max output tokens",
        .detail="**agent_claude_max_tokens** -- property\n\nMaximum output tokens for Claude responses.",
    },
    PropertyDescriptor {
        .name="agent_claude_thinking_mode", .type=CoreVM::LiteralType::String,
        ...
        .readOnly=false, .enumValues=thinkingModeValues,
    },
    PropertyDescriptor {
        .name="agent_claude_prompt_caching", .type=CoreVM::LiteralType::Boolean,
    ...
    PropertyDescriptor {
        .name="agent_claude_auth_type", .type=CoreVM::LiteralType::String,
        ...
        .readOnly=false, .enumValues=authTypeValues,
    },
    // --- OpenAI provider ---
    PropertyDescriptor {
        .name="agent_openai_api_key", .type=CoreVM::LiteralType::String,
        .description="OpenAI API key",
        .detail="**agent_openai_api_key** -- property\n\nSets the OpenAI API key.",
    },
    PropertyDescriptor {
        .name="agent_openai_api_key_env", .type=CoreVM::LiteralType::String,
    ...
    PropertyDescriptor {
        .name="agent_openai_model", .type=CoreVM::LiteralType::String,
        .description="OpenAI model identifier",
        .detail="**agent_openai_model** -- property\n\nSets the OpenAI model identifier.",
        .readOnly=false, .enumValues=openaiModelValues,
    },
    PropertyDescriptor {
        .name="agent_openai_base_url", .type=CoreVM::LiteralType::String,
        .description="OpenAI base URL",
        .detail="**agent_openai_base_url** -- property\n\nSets the OpenAI API base URL.",
    },
    PropertyDescriptor {
        .name="agent_openai_max_tokens", .type=CoreVM::LiteralType::Number,
        .description="OpenAI max output tokens",
        .detail="**agent_openai_max_tokens** -- property\n\nMaximum output tokens for OpenAI responses.",
    },
    PropertyDescriptor {
        .name="agent_openai_thinking_mode", .type=CoreVM::LiteralType::String,
    ...
    PropertyDescriptor {
        .name="agent_openai_compat_base_url", .type=CoreVM::LiteralType::String,
        .description="OpenAI-compatible base URL",
        .detail="**agent_openai_compat_base_url** -- property\n\nSets the OpenAI-compatible API base URL.",
    },
    PropertyDescriptor {
        .name="agent_openai_compat_max_tokens", .type=CoreVM::LiteralType::Number,
        .description="OpenAI-compatible max output tokens",
        .detail="**agent_openai_compat_max_tokens** -- property\n\nMaximum output tokens.",
    },
    PropertyDescriptor {
        .name="agent_openai_compat_thinking_mode", .type=CoreVM::LiteralType::String,
    ...
    // --- Gemini provider ---
    PropertyDescriptor {
        .name="agent_gemini_api_key", .type=CoreVM::LiteralType::String,
        .description="Gemini API key",
        .detail="**agent_gemini_api_key** -- property\n\nSets the Gemini API key.",
    },
    PropertyDescriptor {
        .name="agent_gemini_api_key_env", .type=CoreVM::LiteralType::String,
    ...
    PropertyDescriptor {
        .name="agent_gemini_model", .type=CoreVM::LiteralType::String,
        .description="Gemini model identifier",
        .detail="**agent_gemini_model** -- property\n\nSets the Gemini model identifier.",
        .readOnly=false, .enumValues=geminiModelValues,
    },
    PropertyDescriptor {
        .name="agent_gemini_max_tokens", .type=CoreVM::LiteralType::Number,
        .description="Gemini max output tokens",
        .detail="**agent_gemini_max_tokens** -- property\n\nMaximum output tokens for Gemini responses.",
    },
    PropertyDescriptor {
        .name="agent_gemini_thinking_mode", .type=CoreVM::LiteralType::String,
    ...
    // --- Plan mode ---
    PropertyDescriptor {
        .name="agent_plan_mode_enabled", .type=CoreVM::LiteralType::Boolean,
        .description="Enable/disable plan mode",
        .detail="**agent_plan_mode_enabled** -- property\n\nEnables or disables plan mode.",
        .readOnly=false, .enumValues=boolValues,
    },
    PropertyDescriptor {
        .name="agent_plan_mode_pause_between_steps", .type=CoreVM::LiteralType::Boolean,
    ...
    PropertyDescriptor {
        .name="agent_plan_mode_max_exploration_turns", .type=CoreVM::LiteralType::Number,
    ...
    PropertyDescriptor {
        .name="agent_trusted_tool", .type=CoreVM::LiteralType::Object,
        .description="Auto-approved tools",
        .detail="**agent_trusted_tool** -- property\n\nTools that are auto-approved without user confirmation.",
    },
    PropertyDescriptor {
        .name="agent_blocked_pattern", .type=CoreVM::LiteralType::Object,
        .description="Blocked shell command patterns",
        .detail="**agent_blocked_pattern** -- property\n\nShell command patterns blocked from agent execution.",
    },
    // --- Web search ---
    PropertyDescriptor {
        .name="agent_web_search_engine", .type=CoreVM::LiteralType::String,
        .description="Web search engine",
        .detail="**agent_web_search_engine** -- property\n\nSets the web search engine (duckduckgo, brave, google).",
        .readOnly=false, .enumValues=webSearchEngineValues,
    },
    PropertyDescriptor {
        .name="agent_web_search_api_key", .type=CoreVM::LiteralType::String,
        .description="Web search API key",
        .detail="**agent_web_search_api_key** -- property\n\nAPI key for the selected web search engine.",
    },
    PropertyDescriptor {
        .name="agent_web_search_cx", .type=CoreVM::LiteralType::String,
        .description="Google Custom Search Engine ID",
        .detail="**agent_web_search_cx** -- property\n\nGoogle Custom Search Engine ID.",
    },
    PropertyDescriptor {
        .name="agent_web_search_max_results", .type=CoreVM::LiteralType::Number,
        .description="Max web search results per query",
        .detail="**agent_web_search_max_results** -- property\n\nMaximum number of web search results per query.",
    },
    // --- Local inference ---
    PropertyDescriptor {
        .name="agent_local_model_path", .type=CoreVM::LiteralType::String,
    ...
    PropertyDescriptor {
        .name="agent_local_model_dir", .type=CoreVM::LiteralType::String,
        .description="Directory for downloaded models",
        .detail="**agent_local_model_dir** -- property\n\nSets the directory where downloaded models are stored.",
    },
    PropertyDescriptor {
        .name="agent_local_gpu_layers", .type=CoreVM::LiteralType::Number,
    ...
    PropertyDescriptor {
        .name="agent_local_context_size", .type=CoreVM::LiteralType::Number,
        .description="Context window size in tokens",
        .detail="**agent_local_context_size** -- property\n\nSets the context window size in tokens for local inference.",
    },
    PropertyDescriptor {
        .name="agent_local_threads", .type=CoreVM::LiteralType::Number,
    ...
    PropertyDescriptor {
        .name="agent_local_batch_size", .type=CoreVM::LiteralType::Number,
        .description="Batch size for prompt evaluation",
        .detail="**agent_local_batch_size** -- property\n\nBatch size for prompt evaluation in local inference.",
    },
    PropertyDescriptor {
        .name="agent_local_temperature", .type=CoreVM::LiteralType::Number,
    ...
    PropertyDescriptor {
        .name="agent_local_flash_attention", .type=CoreVM::LiteralType::Boolean,
        .description="Enable Flash Attention",
        .detail="**agent_local_flash_attention** -- property\n\nEnables or disables Flash Attention for local inference.",
        .readOnly=false, .enumValues=boolValues,
    },
    PropertyDescriptor {
        .name="agent_local_max_tokens", .type=CoreVM::LiteralType::Number,
        .description="Maximum tokens to generate",
        .detail="**agent_local_max_tokens** -- property\n\nMaximum number of tokens to generate per response.",
    },
    PropertyDescriptor {
        .name="agent_local_chat_template", .type=CoreVM::LiteralType::String,
    ...
    // --- Error recovery ---
    PropertyDescriptor {
        .name="agent_error_recovery_action", .type=CoreVM::LiteralType::String,
        ...
        .readOnly=false, .enumValues=errorRecoveryActionValues,
    },
    PropertyDescriptor {
        .name="agent_error_recovery_model", .type=CoreVM::LiteralType::String,
        ...
        .readOnly=false, .enumValues=errorRecoveryModelValues,
    },
};
// clang-format on
