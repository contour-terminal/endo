...
///
/// `Task<T>` is the awaitable counterpart to @c endo::Generator: where a
...
///
/// Design (see the TUI coroutine refactor plan):
...
///
/// Unlike @c endo::Generator there is no `std::`-provided fallback to prefer: no
...
#include <coro/Cancellation.hpp>
    ...
    #error "endo::coro::Task requires C++20 coroutine language support (__cpp_impl_coroutine)."
#endif
