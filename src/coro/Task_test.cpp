...
// see platform/Generator_test.cpp). The behavior is correct on every platform; we
// simply cannot assert it through the harness on Windows.
namespace
{
