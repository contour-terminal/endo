...
namespace
{
    ...
    constexpr auto ExtensionTable = std::array<ExtensionMapping, 67> {{
        { "avi",        IconVideo,      VideoColor },
        { "bash",       IconTerminal,   ShellColor },
        { "bz2",        IconArchive,    ArchiveColor },
        { "c",          IconCpp,        CppColor },
        { "cc",         IconCpp,        CppColor },
        { "cfg",        IconConfig,     TextColor },
        { "conf",       IconConfig,     TextColor },
        { "cpp",        IconCpp,        CppColor },
        { "cs",         IconCpp,        CSharpColor },
        { "css",        IconCss,        CssColor },
        { "csv",        IconText,       TextColor },
        { "cxx",        IconCpp,        CppColor },
        { "db",         IconDatabase,   SqlColor },
        { "dockerfile", IconDocker,     DockerColor },
        { "ex",         IconElixir,     ElixirColor },
        { "exs",        IconElixir,     ElixirColor },
        { "flac",       IconAudio,      AudioColor },
        { "gif",        IconImage,      ImageColor },
        { "gitignore",  IconGit,        GitColor },
        { "go",         IconGo,         GoColor },
        { "gz",         IconArchive,    ArchiveColor },
        { "h",          IconCpp,        CppColor },
        { "hpp",        IconCpp,        CppColor },
        { "hs",         IconHaskell,    HaskellColor },
        { "htm",        IconHtml,       HtmlColor },
        { "html",       IconHtml,       HtmlColor },
        { "java",       IconJava,       JavaColor },
        { "jpeg",       IconImage,      ImageColor },
        { "jpg",        IconImage,      ImageColor },
        { "js",         IconJavaScript, JavaScriptColor },
        { "json",       IconJson,       JsonColor },
        { "jsx",        IconJavaScript, JavaScriptColor },
        { "kt",         IconKotlin,     KotlinColor },
        { "lock",       IconLock,       LockColor },
        { "log",        IconText,       TextColor },
        { "lua",        IconLua,        LuaColor },
        { "md",         IconMarkdown,   MarkdownColor },
        { "mkv",        IconVideo,      VideoColor },
        { "mp3",        IconAudio,      AudioColor },
        { "mp4",        IconVideo,      VideoColor },
        { "nix",        IconNix,        NixColor },
        { "pdf",        IconPdf,        PdfColor },
        { "php",        IconPhp,        PhpColor },
        { "png",        IconImage,      ImageColor },
        { "py",         IconPython,     PythonColor },
        { "rb",         IconRuby,       RubyColor },
        { "rs",         IconRust,       RustColor },
        { "scala",      IconScala,      ScalaColor },
        { "scss",       IconCss,        CssColor },
        { "sh",         IconTerminal,   ShellColor },
        { "sql",        IconDatabase,   SqlColor },
        { "svg",        IconImage,      ImageColor },
        { "swift",      IconSwift,      SwiftColor },
        { "tar",        IconArchive,    ArchiveColor },
        { "toml",       IconJson,       JsonColor },
        { "ts",         IconTypeScript, TypeScriptColor },
        { "tsx",        IconTypeScript, TypeScriptColor },
        { "txt",        IconText,       TextColor },
        { "wav",        IconAudio,      AudioColor },
        { "webp",       IconImage,      ImageColor },
        { "xml",        IconHtml,       XmlColor },
        { "xz",         IconArchive,    ArchiveColor },
        { "yaml",       IconJson,       JsonColor },
        { "yml",        IconJson,       JsonColor },
        { "zig",        IconZig,        ZigColor },
        { "zip",        IconArchive,    ArchiveColor },
        { "zsh",        IconTerminal,   ShellColor },
    }};
    // clang-format on
