...
| Multi-process pipes | ✅ |
| Builtins: `exit`, `true`, `false`, `read` (-p/-r/-s/-n/-t/-d, IFS splitting), `cd` (incl. `cd -`), `set`, `unset`, `export`, `bind`, `echo`, `which`, `cat` (-n/-b/-s/-E/-T/-A/-r/--range), `sleep`, `fetch`, `rm` (-r/-R/-f/-d/-v/-i/--recursive/--force/--dir/--verbose/--help/--), `mkdir` (-p/-v/--parents/--verbose/--help/--), `cp` (-r/-R/-f/-n/-v/--recursive/--force/--no-clobber/--verbose/--help/--) | ✅ |
